...
def test_ans():
  options = [
    '--add-option=device-3:streams_in=/data/virtualenv/ducky-2.7/ducky/tests/forth/ans-testsuite/src/%s' % f for f in ['prelimtest.fth', 'tester.fr', 'core.fr', 'coreplustest.fth', 'utilities.fth', 'errorreport.fth']
