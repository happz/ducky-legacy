...
def test_ans():
  ...
  return run_forth_vm(out = logs_dir('forth-ans.out'), machine = logs_dir('forth-ans.machine'), options = options, coverage_name = 'forth-ans', diff_expected = ('forth', 'ans.expected'))
