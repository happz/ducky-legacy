...
#include "arch/rtc.h"
  ...
  .type isr_stack, space, PAGE_SIZE
  .type jiffies, word, 0x0
  .type ap_running, word, 0x0


  .data

  .type foo, word, jiffies
...
__secondary_thread_setup_loop:
  ...
  // and now spin and increase counter till machine halts
  li r2, 0xFFF
