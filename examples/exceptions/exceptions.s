...
#include "arch/boot.h"
  ...
  .type __stack, space, PAGE_SIZE
  .type __exc_stack, space, PAGE_SIZE


  .section .rodata

  .type dummy_message, string, "Unhandled exception\r\n"
  .type divide_by_zero_message, string, "Divide by zero attempted\r\n"
  .type unaligned_access_message, string, "Unaligned access attempted\r\n"
  .type invalid_opcode_message, string, "Invalid opcode\r\n"

  .align 2

  .type __unaligned_memory_access_1, byte, 0x00
  .type __unaligned_memory_access_2, byte, 0x00
...
__exc_invalid_opcode:
  push r0
  la r0, invalid_opcode_message
  call __puts
  pop r0
  retint
...
__exc_init_loop:
  ...
  li r0, BOOT_EVT_ADDRESS
  li r1, EXCEPTION_INVALID_OPCODE
  mul r1, 8
  add r0, r1
  la r1, __exc_invalid_opcode
  stw r0, r1
